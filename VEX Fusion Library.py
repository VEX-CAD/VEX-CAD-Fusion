...
# Create our addin definition object
    ...
    # my_addin.add_custom_event("VEX Fusion Library_message_system", SampleCustomEvent1)

    # my_addin.add_document_event("VEX Fusion Library_open_event", app.documentActivated, SampleDocumentEvent1)
    # my_addin.add_document_event("VEX Fusion Library_close_event", app.documentClosed, SampleDocumentEvent2)

    # my_addin.add_workspace_event("VEX Fusion Library_workspace_event", ui.workspaceActivated, SampleWorkspaceEvent1)

    # my_addin.add_web_request_event("VEX Fusion Library_web_request_event", app.openedFromURL, SampleWebRequestOpened)

    # my_addin.add_command_event("VEX Fusion Library_command_event", app.userInterface.commandStarting, SampleCommandEvent)
